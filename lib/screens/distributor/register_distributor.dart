...
class RegisterDistributorScreen extends StatefulWidget {
  @override
  _RegisterDistributorScreenState createState() => _RegisterDistributorScreenState();
}

class _RegisterDistributorScreenState extends State<RegisterDistributorScreen> {
  ...
  Future<void> _registerDistributor() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Distributor registered successfully!')),
      );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Register Distributor'),
